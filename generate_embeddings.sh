...
python umap_fit.py --input_path='world_data/rawdata_world.csv' --output_path='output/umap_world.csv' --d=2
python umap_fit.py --input_path='world_data/rawdata_world.csv' --output_path='output/umap_world.csv' --d=3
